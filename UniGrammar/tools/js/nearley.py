...
from UniGrammarRuntime.backends.js.nearley import NearleyParserFactory, masterBranchURI
...
class NearleyRunner(NotYetImplementedRunner):
	__slots__ = ()

	COMPILER = DummyCompiler
	PARSER = NearleyParserFactory
